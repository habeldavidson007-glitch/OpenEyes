...
class Fragment:
    ...
    sector: Optional[str] = None  # Economy sector: FIN, ENR, COM, MAC, GEO, REG
    ...
    grundy_value: int = -1                    # For game-theoretic analysis
    robustness_status: str = 'PENDING'        # PENDING, VERIFIED, CHALLENGED
