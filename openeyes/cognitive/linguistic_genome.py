...
class LinguisticGenome:
    ...
    def deconstruct_fact(self, text: str, domain: str = "general") -> AtomicFact:
        ...
        verbs_common = [
            "increases", "decrease", "decreases", "increase", "rises", "rise", "rising", "rose",
            "falls", "fall", "falling", "fell", "shows", "show", "showing", "showed",
            "causes", "cause", "leading", "leads", "led", "results", "result", "meaning", "means", "meant", "representing", "represents", "represented",
            "slows", "slow", "slowing", "accelerates", "accelerate", "accelerating", 
            "grows", "grow", "growing", "grew", "shrinks", "shrink", "shrinking", "shrank", "expands", "expand", "expanding", "expanded",
            "eroding", "erodes", "erode", "improving", "improves", "improve", "improved",
            "worsening", "worsens", "worsen", "strengthening", "strengthens", "strengthen", "strengthened",
            "weakening", "weakens", "weaken", "weakened",
            "is", "are", "was", "were", "has", "have", "had", "having", "be", "been", "being", "am",
            "spikes", "spike", "spiking", "spiked", "surges", "surge", "surging", "surged",
            "jumps", "jump", "jumping", "jumped", "climbs", "climb", "climbing", "climbed",
            "peaks", "peak", "peaking", "peaked", "plunges", "plunge", "plunging", "plunged",
            "drops", "drop", "dropping", "dropped", "slides", "slide", "sliding", "slid",
            "tumbles", "tumble", "tumbling", "tumbled",
            "creates", "create", "creating", "created", "generates", "generate", "generating", "generated",
            "produces", "produce", "producing", "produced",
            "continues", "continue", "continuing", "continued", "remains", "remain", "remaining", "remained",
            "stays", "stay", "staying", "stayed",
            "indicates", "indicate", "indicating", "indicated", "suggests", "suggest", "suggesting", "suggested",
            "signals", "signal", "signaling", "signalled",
            "drives", "drive", "driving", "drove", "driven", "pushes", "push", "pushing", "pushed",
            "pulls", "pull", "pulling", "pulled",
            "triggers", "trigger", "triggering", "triggered", "sparks", "spark", "sparking", "sparked",
            "fuels", "fuel", "fueling", "fueled",
            "reduces", "reduce", "reducing", "reduced", "affects", "affect", "affecting", "affected",
            "determines", "determine", "determining", "determined", "impacts", "impact", "impacting", "impacted",
            "influences", "influence", "influencing", "influenced",
            "correlates", "correlate", "correlating", "correlated", "relates", "relate", "relating", "related",
            "links", "link", "linking", "linked",
            # Critical missing verbs - raises, lowers, adjusts, etc.
            "raises", "raise", "raising", "raised", "lower", "lowers", "lowering", "lowered",
            "adjusts", "adjust", "adjusting", "adjusted", "changes", "change", "changing", "changed",
            "shifts", "shift", "shifting", "shifted", "moves", "move", "moving", "moved",
            "exceeds", "exceed", "exceeding", "exceeded", "surpasses", "surpass", "surpassing", "surpassed",
            "outpaces", "outpace", "outpacing", "outpaced",
            "contracts", "contract", "contracting", "contracted", "compresses", "compress", "compressing", "compressed",
            "amplifies", "amplify", "amplifying", "amplified", "magnifies", "magnify", "magnifying", "magnified",
            "intensifies", "intensify", "intensifying", "intensified",
            "mitigates", "mitigate", "mitigating", "mitigated", "alleviates", "alleviate", "alleviating", "alleviated",
            "eases", "ease", "easing", "eased",
            "accelerating", "decelerating", "decelerates", "decelerate", "moderating", "moderates", "moderate",
            "stabilizing", "stabilizes", "stabilize", "stabilised", "stabilises",
            "hovers", "hover", "hovering", "hovered",
            "oscillates", "oscillate", "oscillating", "oscillated", "fluctuates", "fluctuate", "fluctuating", "fluctuated",
            "plateaus", "plateau", "plateauing", "plateaued", "bottoms", "bottom", "bottoming", "bottomed",
            "tops", "top", "topping", "topped",
            "breaches", "breach", "breaching", "breached", "dips", "dip", "dipping", "dipped",
            "rebounds", "rebound", "rebounding", "rebounded",
            "recovers", "recover", "recovering", "recovered", "rallies", "rally", "rallying", "rallied",
            "retreats", "retreat", "retreating", "retreated",
            "gains", "gain", "gaining", "gained", "loses", "lose", "losing", "lost",
            "winning", "wins", "win", "won"
        ]
